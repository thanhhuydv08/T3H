...
public class Bt2_JFileChooser {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Bt2_JFileChooser window = new Bt2_JFileChooser();
	...
	private void initialize() {
		...
		txtPicture.setBounds(181, 74, 212, 20);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int check = chooser.showOpenDialog(frmThoo);
		...
		button.setBounds(403, 73, 35, 23);
		frmThoo.getContentPane().add(button);
	}
}
...
//String url="";
//JFileChooser  chooser = new JFileChooser();
//FileNameExtensionFilter extensionFilter = new FileNameExtensionFilter("Picture", "jpg","jped");
//int file = chooser.showOpenDialog(frmThoo);
